...
const Navbar = () => {
    ...
    return (
        <div className=' shadow-md flex justify-between items-center h-24 w-full px-10 text-white cursor-pointer '>
            <h1 className=' w-full text-3xl font-bold text-sky-500'>AMAR.</h1>
            ...
            <div onClick={handleNav} className='block md:hidden'>
                {isNavOpen ? <AiOutlineEllipsis size={20} /> : <AiOutlineMenu size={20} />}
            </div>
            <div className={isNavOpen ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#121212] ease-in-out duration-500' : 'fixed left-[-100%]'}>
